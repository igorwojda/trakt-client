package com.igorwojda.traktclient.core.mvp.conductor.extension
...
//
//val Controller.presenter: TrendingMovieListPresenter
//	get() = daggerComponent.trendingMoviePresenter()